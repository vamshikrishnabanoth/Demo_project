...
export default function useExamProctoring({
            ...
            if (document.hidden) {
                ...
                setTabSwitchCount((prevCount) => {
                    ...
                    if (newCount < maxTabSwitches) {
                        toast.error(`Security Warning: Tab switching detected! (${newCount}/${maxTabSwitches} warnings). Exceeding this limit auto-submits your exam.`, { duration: 5000 });
                    }
    ...
    useEffect(() => {
        ...
        const handleBlur = () => {
            ...
            toast.error("Focus Lost! Return to the exam tab immediately to avoid automatic submission.", {
                id: 'focus-loss-alert',
                duration: 60000
            });
        };
    ...
    useEffect(() => {
        ...
        const handleKeyDown = (e) => {
            ...
            if (isPrintScreen || isScreenshotCombo || isDevTools) {
                ...
                toast.error(`Security Violation: ${label} detected and blocked! This activity has been recorded.`, { duration: 5000 });
    ...
    useEffect(() => {
        ...
        const blockClipboard = (e) => {
            e.preventDefault();
                toast.error(`Clipboard action (${e.type}) is blocked during the exam.`, { duration: 4000 });
            recordViolation('clipboard_action', { type: e.type });
        };

        const blockContextMenu = (e) => {
            e.preventDefault();
                toast.error("Right-click context menu is disabled to maintain exam security.", { duration: 4000 });
