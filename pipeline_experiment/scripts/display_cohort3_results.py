...
print("=" * 130)
print("COHORT 3: VOICE + PPT / CODE (MULTIMODAL CLASSROOMS) - 3-WAY COMPARATIVE RESULTS")
print("=" * 130)
header = "{:<38} | {:<5} | {:<5} | {:<5} | {:<7} | {:<7} | {:<20} | {:<12} | {:<18}".format(
    "Input ID", "Q_A", "Q_B", "Q_C", "d(C-A)", "d(C-B)", "Winner", "Bloom (A/B/C)", "Grounding (A/B/C)"
)
print(header)
print("=" * 130)

for r in cohort3_data:
    row = "{:<38} | {:<5.3f} | {:<5.3f} | {:<5.3f} | {:<+7.3f} | {:<+7.3f} | {:<20} | {:<3}/{:<3}/{:<4} | {:<4}%/{:<4}%/{:<4}%".format(
        r["input_id"][:38],
        r["q_a"], r["q_b"], r["q_c"],
