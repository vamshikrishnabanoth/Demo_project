...
module.exports = {
  ...
  PIPELINE_VERSION: process.env.CACHE_PIPELINE_VERSION || '4.1.0',
  OCR_VERSION: process.env.CACHE_OCR_VERSION || '2.1.0',
  WHISPER_VERSION: process.env.CACHE_WHISPER_VERSION || 'whisper-large-v3',
  ANALYSIS_VERSION: process.env.CACHE_ANALYSIS_VERSION || '3.0.0',
  PROMPT_VERSION: process.env.CACHE_PROMPT_VERSION || '2.5.0',
  PLANNER_VERSION: process.env.CACHE_PLANNER_VERSION || '1.2.0',
  VALIDATOR_VERSION: process.env.CACHE_VALIDATOR_VERSION || '2.0.0',
