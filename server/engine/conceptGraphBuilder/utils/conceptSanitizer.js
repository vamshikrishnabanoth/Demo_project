...
const ACRONYM_BLACKLIST = new Set([
  ...
  'AUTONOMOUS', 'INSTITUTE', 'COMPUTER', 'SCIENCE', 'ENGINEERING', 'III', 'I', 'II', 'IV',
  'SEMESTER', 'SYLLABUS', 'ARTIFICIAL', 'ACCREDITED', 'APPROVED', 'AFFILIATED', 'JNTUH',
  'HYDERABAD', 'KMIT', 'DEPARTMENT', 'PROFESSOR', 'ASSISTANT', 'ASSISTANT PROFESSOR',
  'PREPARED BY', 'COURSE', 'DEGREE', 'YEAR', 'B.TECH', 'BTECH', 'MTECH'
]);
